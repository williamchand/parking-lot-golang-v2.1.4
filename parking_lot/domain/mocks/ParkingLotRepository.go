...
// UpdateUnOccupied provides a mock function with given fields: ctx, id, updatedAt
func (_m *ParkingLotRepository) UpdateUnOccupied(ctx context.Context, id int64, updatedAt time.Time) error {
